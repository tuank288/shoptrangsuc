...
<div class="row">
    ...
    <div class="col col-sm-4">
        ...
        <?php echo $this->Form->control('billing_address', ['class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('billing_address2', ['class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('billing_city', ['class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('billing_state', ['options' => $this->Site->states(), 'empty' => 'Please Select', 'class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('billing_zip', ['class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('billing_country', ['class' => 'form-control']); ?>
        <br />
        <br />

        <?php echo $this->Form->control('sameaddress', ['type' => 'checkbox', 'label' => 'Copy Billing Address to Shipping']); ?>
    ...
    <div class="col col-sm-4">
        ...
        <br />
        <?php echo $this->Form->control('shipping_zip', ['class' => 'form-control']); ?>
        <br />
        <?php echo $this->Form->control('shipping_country', ['class' => 'form-control']); ?>
        <br />
        <br />
